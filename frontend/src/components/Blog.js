        ...
        blogs.map(blogPost => {
            return list.push(                    
                <div className="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                    ...
                    <div className="col-auto d-none pr-4 d-lg-block">
        ...
        <div className="container mt-3">
            <div className="nav-scroller py-1 mb-2">
                <nav className="nav d-flex justify-content-between">
                    ...
                    <Link className="p-2 text-muted" to="/category/education">Education</Link>
                    <Link className="p-2 text-muted" to="/category/environment">Environment</Link>
                    <Link className="p-2 text-muted" to="/category/food">Food</Link>
            ...
            <div className="row no-gutters border text-white rounded bg-dark overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div className="col-auto d-none pr-4 d-lg-block">
                    <img width='200' height='250' src={featuredBlog.thumbnail} alt='thumbnail' />
                </div>
                <div className="col p-4 d-flex flex-column position-static">
                    <h1 className="text-warning">Featured Post</h1>
                    <h3 className="mb-0">{featuredBlog.title}</h3>
                    <p className="card-text mb-auto">{featuredBlog.excerpt}</p>
                    <Link to={`/blog/${featuredBlog.slug}`} className="text-info">Continue reading</Link>
                </div>
            </div>
            {/* <div className="jumbotron p-4 p-md-5 text-white rounded bg-dark"> */}
                {/* <div className="col-auto d-none pr-4 d-lg-block align-item-left">
                    <img width='200' height='200' src={featuredBlog.thumbnail} alt='thumbnail' />
                </div>
                <div className="col-md-6 px-0 d-flex flex-column position-static align-item-right">
            ...
            {/* <div className="text-center mb-3">
                <Link className="btn btn-primary btn-lg" exact to="/create" role="button">Create Blog</Link>
            </div> */}
            {getBlogs()}
        </div>
    );
